...
test('JSON object key ordering does not change quote equivalence',()=>{const f=fixture('car');f.response.quotes[0].insurance.coverages=f.response.quotes[0].insurance.coverages.map(c=>Object.fromEntries(Object.entries(c).reverse()));validate(f);});
